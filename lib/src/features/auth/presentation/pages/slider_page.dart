          ...
          children: [
            SizedBox(
              ...
              child: PageView(
                ...
                children: [
                  _itemSlider('assets/icons/ic_intro_1.svg',
                      S.of(context).intro_title_1, S.of(context).intro_desc_1),
                  _itemSlider('assets/icons/ic_intro_2.svg',
                      S.of(context).intro_title_2, S.of(context).intro_desc_2),
                  _itemSlider('assets/icons/ic_intro_3.svg',
                      S.of(context).intro_title_3, S.of(context).intro_desc_3),
                  _itemSlider('assets/icons/ic_intro_4.svg',
                      S.of(context).intro_title_4, S.of(context).intro_desc_4),
                ],
              ),
            ),
            DotsIndicator(
              ...
              child: GestureDetector(
                  onTap: () {
                    if (_index != 3) {
                      setState(() {
                        _index++;
                        controller.animateToPage(_index, duration: Duration(milliseconds: 2), curve: Curves.linear);
                      });
                    } else {
                      Navigator.of(context).pushNamed(AppRoutes.LANGUAGE);
                    }
                  },
                  child: AppButton(text: S.of(context).next)),
            )
          ],
        ),
      ),
