...
class RegionsUseCase implements UseCase<DataState<List<RegionsModel>>, int> {
  final HomeRepository _repository;

  RegionsUseCase(this._repository);

  @override
  Future<DataState<List<RegionsModel>>> call({required int params}) async => await _repository.regions();
}