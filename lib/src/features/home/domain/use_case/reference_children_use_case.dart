...
class ReferenceChildrenUseCase
    implements UseCase<DataState<List<ReferenceModel>>, int> {
  final HomeRepository _repository;

  ReferenceChildrenUseCase(this._repository);

  @override
  Future<DataState<List<ReferenceModel>>> call({required int params}) async =>
      await _repository.referenceChildren(params);
}
